...
namespace FortniteCPGenerator
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            richTextBox3.Text = (string)Parsed["data"]["rarity"]["backendValue"];
            richTextBox4.Text = "Chapter " + (string)Parsed["data"]["introduction"]["chapter"] + " Season " + (string)Parsed["data"]["introduction"]["season"];
            richTextBox5.Text = (string)Parsed["data"]["set"]["value"];
        }
